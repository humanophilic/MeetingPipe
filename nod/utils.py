...
#poses batch*6
#poses
def compute_rotation_matrix_from_ortho6d(poses, gpu_id):
    x_raw = poses[:,0:3]#batch*3
    y_raw = poses[:,3:6]#batch*3
        
    x = normalize_vector(x_raw, gpu_id) #batch*3
    z = cross_product(x,y_raw) #batch*3
    z = normalize_vector(z, gpu_id)#batch*3
